...
export const getUserGame = (gameId) =>
    axios.get(`${BASE_URL}/users/${USER_ID}/games/${gameId}`)

export const getAllAchievements = (gameId) =>
    axios.get(`${BASE_URL}/games/${gameId}/achievements`)